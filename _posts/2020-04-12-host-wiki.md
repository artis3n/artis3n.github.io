...
That is the say, organized chaos.

![Mindmap example](/img/host-wiki/mindmap-example.png)
...
![Wiki visual example](/img/host-wiki/wiki-example.png)

Everything is organized in a tree off of the home page:

![Wiki home page](/img/host-wiki/wiki-homepage.png)

And I can globally search if I need to look something up:

![Wiki global search](/img/host-wiki/global-search.png)
...
![Cognito login form](/img/host-wiki/cognito-login-form.png)

I am going to step through everything in this article.

A [Cloudcraft][] view of my architecture:

![AWS architecture](/img/host-wiki/architecture.png)
...
![efs settings](/img/host-wiki/efs-settings.png)
...
![efs client settings](/img/host-wiki/efs-client-settings.png)
...
![EC2 instance details](/img/host-wiki/ec2-instance-details.png)
...
![ALB config](/img/host-wiki/alb-config.png)
...
![ALB routing](/img/host-wiki/alb-routing.png)

Gollum runs on port 4567 and the home page will exist at `/Home`.
...
![SG LB forward](/img/host-wiki/sg-lb-forward.png)

I'm cutting off the security group name here, but AWS will give you a dropdown of other security groups so you can easily hook it up.
...
![Cognito attributes](/img/host-wiki/cognito-attributes.png)
...
![Cognito app client](/img/host-wiki/cognito-app-client.png)
...
![Cognito domain name](/img/host-wiki/cognito-domain-name.png)

I entered my domain prefix of choice for an Amazon Cognito domain.

Now we need to configure App client settings.

![Cognito app client settings](/img/host-wiki/cognito-app-client-settings.png)
...
![ALB listeners](/img/host-wiki/alb-listeners.png)

On the HTTP 80 rule, make sure your traffic redirects to port 443.

![HTTP redirect](/img/host-wiki/80-redirect-rule.png)
...
![auth rule path](/img/host-wiki/auth-rule-path.png)
...
![auth rule cognito](/img/host-wiki/auth-rule-cognito.png)
...
![Price on-demand instance](/img/host-wiki/budget-ondemand.png)
...
![Budget spot instances](/img/host-wiki/budget-spot.png)
...
That allows me to remove the ALB entirely, eliminating that cost and bringing my monthly bill to $2.56/month.
Much more manageable.
I will write a follow-up article describing how I re-architect my system to access my wiki via Tailscale.
